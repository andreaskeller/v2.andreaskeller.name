...
export const meta = {
  ...
  description: `Über den Jahreswechsel landen viele Jahresrückblicke, unter anderem von Nathan Barry, Justin Jackson, Kent C. Dodds und Matt Olpinski in meiner Inbox. Da ich in diesem Jahr den Schritt in die Selbständigkeit gemacht habe, ist es ein perfekter Zeitpunkt für mich auch mit dieser Tradition zu starten.`,
...
Über den Jahreswechsel landen viele Jahresrückblicke, unter anderem von Nathan Barry, Justin Jackson, Kent C. Dodds und Matt Olpinski in meiner Inbox. Da ich in diesem Jahr den Schritt in die Selbständigkeit gemacht habe, ist es ein perfekter Zeitpunkt für mich auch mit dieser Tradition zu starten.
